...
// the holy jesus of variables holy fuck this does so much
var User;
// god is literally above this comment
...
function setup(){
  User.sync({force: true}) // We use 'force: true' in this example to drop the table users if it already exists, and create a new one. You'll most likely want to remove this setting in your own apps
    .then(function(){                // shut the fuck up
      // fuck you
...
app.use(express.static('piss'));

// http://expressjs.com/en/starter/basic-routing.html
app.get("/", function (request, response) {
  response.sendFile(__dirname + 'custom.html');
});
